...
--
-- Client: 127.0.0.1
-- Généré le: Lun 24 Décembre 2012 à 05:26
...
(2, 1, 1, 8, NULL, NULL, NULL, 'Fanontaniana mikasika ny forum', 51, 5, 0, NULL, 0, NULL, NULL, 0),
...
INSERT INTO `cc_user_profile` (`id`, `fk_user_id`, `avatar_is_remote`, `avatar`, `aim`, `aim_is_public`, `msn`, `msn_is_public`, `icq`, `icq_is_public`, `yahoo`, `yahoo_is_public`, `website`, `location`, `bio`, `signature`) VALUES
(1, 1, 0, 'D:\\Document\\Icon\\logo\\Abuledu.jpg', NULL, 0, 'fenouh_r@hotmail.com', 1, NULL, 0, 'psa@yahoo.fr', 1, 'www.psaep-caadp-mg.org', 'Antananarivo', 'za dia bandy ts mahay n''inin fa d manao fotsin', 'f.rakotonjanahary psaep-caadp-mg.org'),
(3, 2, 0, NULL, NULL, 0, NULL, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL),
(5, 3, 0, NULL, NULL, 0, NULL, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL),
(7, 4, 0, NULL, NULL, 0, NULL, 0, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL);
...
(1, 1, 'psasuper', 'psasuper', 'psasuper@mada.com', 'psasuper@mada.com', 1, 'fl3ntmezapwgggo0gs8gw4kk444o08o', 'ssBW6S5CGiUTBJwQdqdc6oXdNPqwFVJCP6DLm8MRcVDEfuIGjaEXOKxk2VYK6sETHS5su/GzqKOWLOqmRLn6Dg==', '2012-12-23 16:03:34', 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:16:"ROLE_SUPER_ADMIN";}', 0, NULL, NULL, NULL, NULL, NULL),
(2, 3, 'psaadmin', 'psaadmin', 'psaadmin@mada.fr', 'psaadmin@mada.fr', 1, 'pp8cp69nw6s808og00g0gowso04k0kc', 'f+BYnSW9PaZApB+RnZCyD4S3F2D+b01r63fSiAWYiUa+rYKIrqI6wuJkphLsGDKxuqre8tLrskO2LqRXN8B99A==', '2012-12-23 14:39:03', 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:10:"ROLE_ADMIN";}', 0, NULL, NULL, NULL, NULL, NULL),
(3, 5, 'psauser', 'psauser', 'psauser@mada.com', 'psauser@mada.com', 1, 'i4791ry6zpk4o80gs08wk8gkcw8408k', 'ZpVQzqJPph1wDI4WRlGVe7hEHA50rKUorntg7gBGZjL6pvJw2Zd8KuatLiDp7o2Fey+w9oY5TjYrjtH7ADO9+A==', '2012-12-23 09:40:38', 0, 0, NULL, NULL, NULL, 'a:0:{}', 0, NULL, NULL, NULL, NULL, NULL),
(4, 7, 'psamoderator', 'psamoderator', 'psamoderator@hotmail.com', 'psamoderator@hotmail.com', 1, '83fuz5tgs7k8kk8c8ksw0wcgowsk04w', 'jjWS/NIHNltOf5b4pDHaEcL8gNznKziYFhrkQ4gfm0dM4R3sNS0KzaYMlzbpKhOGukHlUKn8HvCSFg8rdhO8YQ==', '2012-12-24 04:24:49', 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:14:"ROLE_MODERATOR";}', 0, NULL, NULL, NULL, NULL, NULL);
...
(2, 'admin', 'admin', 'admin@admin.com', 'admin@admin.com', 1, '1lhfohvywffo0wgc0skc8k4wsc0s8gg', 'gz8w/6B3wD7WWc+eWEv1urgX1HCy+kqnuE0si7uA3KY8yD2Cg3IzYfD9F8QIIbOBpOmRG1g6sFEJIarMVcyh6w==', '2012-12-16 18:27:07', 0, 0, NULL, '17r8n51cvypwc4s00g0g44gcwkwkws0c8sk088gwowk8ss44g4', NULL, 'a:1:{i:0;s:16:"ROLE_SUPER_ADMIN";}', 0, NULL),
(3, 'fenonantenaina', 'fenonantenaina', 'feno@test.com', 'feno@test.com', 1, 'znr8pqz8r280kcs80ogcgoc4ococw0', '+HfFy3Vl8UTjmv8T1uFZFaAYqnrNA1WpP6kKaFbK8FZ6wt9bU11ZUG6vbeatp9uuj++dr0hVvenNHDIZoXk3KA==', '2012-12-16 19:30:46', 0, 0, NULL, NULL, NULL, 'a:0:{}', 0, NULL);
...
CREATE TABLE CC_Message_Folder (id INT AUTO_INCREMENT NOT NULL, fk_owned_by_user_id INT DEFAULT NULL, name LONGTEXT NOT NULL, special_type INT DEFAULT NULL, cached_read_count INT DEFAULT NULL, cached_unread_count INT DEFAULT NULL, cached_total_message_count INT DEFAULT NULL, INDEX IDX_DA623A813BB9921A (fk_owned_by_user_id), PRIMARY KEY(id)) ENGINE = InnoDB;
CREATE TABLE CC_Message_Message (id INT AUTO_INCREMENT NOT NULL, fk_folder_id INT DEFAULT NULL, fk_sent_to_user_id INT DEFAULT NULL, fk_from_user_id INT DEFAULT NULL, fk_owned_by_user_id INT DEFAULT NULL, fk_attachment_id INT DEFAULT NULL, subject VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, sent_date DATETIME DEFAULT NULL, created_date DATETIME DEFAULT NULL, send_to LONGTEXT NOT NULL, is_draft TINYINT(1) NOT NULL, is_read TINYINT(1) NOT NULL, is_flagged TINYINT(1) NOT NULL, INDEX IDX_C9E1FDF777756ED2 (fk_folder_id), INDEX IDX_C9E1FDF7E34CC5D2 (fk_sent_to_user_id), INDEX IDX_C9E1FDF7ED3223 (fk_from_user_id), INDEX IDX_C9E1FDF73BB9921A (fk_owned_by_user_id), INDEX IDX_C9E1FDF7602E9349 (fk_attachment_id), PRIMARY KEY(id)) ENGINE = InnoDB;
CREATE TABLE CC_Message_Registry (id INT AUTO_INCREMENT NOT NULL, fk_owned_by_user_id INT DEFAULT NULL, cached_unread_message_count INT NOT NULL, INDEX IDX_2EB44AD53BB9921A (fk_owned_by_user_id), PRIMARY KEY(id)) ENGINE = InnoDB;
